...
export const CONEJO_CLIP_NAMES = ["idle-wobble", "adjust-mic"] as const;

export type ConejoClipBuilder = (root: THREE.Object3D, speed?: number) => THREE.AnimationClip[];
...
export const buildConejoClips: ConejoClipBuilder = (root, speed = 1): THREE.AnimationClip[] => {
